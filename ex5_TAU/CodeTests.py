...
# TEST FOR Q1
infile = "q1_in.txt"
assert(ex5_0123456789.sum_file_nums(infile)==8.0)
infile = "q1_in2.txt"
assert(ex5_0123456789.sum_file_nums(infile)==0.0)

# # TEST FOR Q2
# infile = "q2_in.txt"
# outfile = "q2_out.txt"
# expected_out = "q2_out_expected.txt"
# ex5_0123456789.filter_file_nums(infile,outfile)
...
x=2
ex5_0123456789.get_x_freqs(infile, outfile, x)
...
# TEST FOR Q4
infile = "q4_good.csv"
matrix = ex5_0123456789.get_csv_matrix(infile)
...
ex5_0123456789.decode( input_text_file, code_mapping_file , output_text_file)
